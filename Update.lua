							...
							local unzip = function(res, ...)
								if res == "sysUnzipDone" then
									...
									tempTimer(1,function()
										...
										cecho("\n<tomato> Barsawia skrypty zaktualizowane poprawnie!\n")
									end)
